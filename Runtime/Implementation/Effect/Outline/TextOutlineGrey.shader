Shader "TextEffect/Text2DOutlineGrey"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                fixed4 outlineColorOut = IN.uv3;//gammaToLinear(IN.uv3);
                fixed4 shadowOutlineColorOut = IN.tangent;//gammaToLinear(IN.tangent);                
